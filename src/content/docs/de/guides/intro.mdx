...
<Tabs>
  <TabItem label="Maßgeschneiderte Lösungen">
    Jedes Bauprojekt birgt seine eigenen Herausforderungen und Anforderungen. Bei Rikoshea passen wir unsere Dienstleistungen an Ihre spezifischen Bedürfnisse an, um sicherzustellen, dass unser Team unabhängig von der Größe oder Komplexität Ihres Projekts damit präzise und professionell umgehen kann.
  </TabItem>
