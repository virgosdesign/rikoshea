...
function _createMdxContent(props) {
  return createVNode($$CardGrid, {
    ...
    children: [createVNode($$Card, {
      ...
      icon: "seti:eslint",
      "set:html": "<p>Discover the complete lineup of Rikoshea’s superior quality tools and equipment. Each subsection offers detailed specifications, usage instructions, and maintenance tips.</p>"
    }), createVNode($$Card, {
...
const file = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/welcome-to-docs.mdx";
...
Content.moduleId = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/welcome-to-docs.mdx";
