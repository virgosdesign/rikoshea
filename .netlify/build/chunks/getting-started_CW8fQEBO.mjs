...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Rikoshea Docsへようこそ！私たちは、プレミアムツールでのスタートをお手伝いできることを楽しみにしています。このガイドは、私たちのツールの範囲を紹介し、基本を理解し、最初のプロジェクトに備えるための設計されています。Rikosheaとともに、高品質で信頼性の高い技術の世界に飛び込みましょう。</p>\n<h2 id=\"ツールの概要\">ツールの概要</h2>\n"
...
const file = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/ja/guides/getting-started.mdx";
...
Content.moduleId = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/ja/guides/getting-started.mdx";
