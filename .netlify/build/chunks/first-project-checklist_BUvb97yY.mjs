...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Embarking on a new project can be exciting and challenging in equal measure. With the right preparation and guidance, your venture is poised for success. The Rikoshea First Project Checklist is designed to provide a clear and structured approach to ensure you’re well-prepared every step of the way.</p>\n<h2 id=\"project-preparation\">Project Preparation</h2>\n"
      ...
      children: [createVNode($$Card, {
        ...
        "set:html": "<ul>\n<li>Make a list of all required Rikoshea tools and equipment</li>\n<li>Verify inventory availability and condition before starting</li>\n</ul>"
      }), createVNode($$Card, {
        title: "Arranging Services",
        "set:html": "<ul>\n<li>If additional expertise or manpower is needed, arrange for Rikoshea construction services in advance</li>\n<li>Clarify service level agreements and timelines with your Rikoshea representative</li>\n</ul>"
      })]
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<h2 id=\"project-execution\">Project Execution</h2>\n<h3 id=\"initial-phase\">Initial Phase</h3>\n"
    }), createVNode($$Steps, {
      "set:html": "<ol>\n<li>\n<p>Set up the project site according to Rikoshea setup guidelines</p>\n</li>\n<li>\n<p>Conduct an initial team meeting to align on project goals and Rikoshea methodologies</p>\n</li>\n<li>\n<p>Establish project checkpoints and milestones for regular assessment</p>\n</li>\n</ol>"
    }), "\n", createVNode(Fragment$1, {
      "set:html": "<h2 id=\"additional-resources\">Additional Resources</h2>\n"
    }), createVNode($$CardGrid, {
      children: [createVNode($$LinkCard, {
        title: "Detailed Guides",
        description: "Access in-depth documentation and user manuals for Rikoshea tools and services.",
        href: "/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Support Contacts",
        description: "Keep handy the contact details for Rikoshea support, available for assistance throughout your project.",
        href: "/guides/getting-started"
      }), createVNode($$LinkCard, {
        title: "Advanced Learning",
        description: "Explore further educational resources provided by Rikoshea to refine your skills and knowledge base.",
        href: "/guides/getting-started"
      })]
    })]
  });
...
const file = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/guides/first-project-checklist.mdx";
...
Content.moduleId = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/guides/first-project-checklist.mdx";
