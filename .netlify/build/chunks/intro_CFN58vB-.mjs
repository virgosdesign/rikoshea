...
import { e as $$Tabs, f as $$TabItem } from './Code_CYjyQ-e6.mjs';
import './prerender_DPSU56eQ.mjs';
import 'clsx';

const frontmatter = {
  "title": "Introduction to Rikoshea Services",
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode($$TabItem, {
        ...
        "set:html": "<p>Each construction project carries its unique challenges and demands. At Rikoshea, we customize our services to match your specific needs, ensuring that no matter the scale or complexity of your project, our team is equipped to handle it with precision and professionalism.</p>"
      }), createVNode($$TabItem, {
        label: "Expert Team",
...
const file = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/guides/intro.mdx";
...
Content.moduleId = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/guides/intro.mdx";
