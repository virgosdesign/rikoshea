...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      "set:html": "<p>Dive deep into the technicalities of our product offerings with Rikoshea’s comprehensive technical specifications documentation. Our detailed data sheets provide you with all the information you need on:</p>\n"
      ...
      "set:html": "<h2 id=\"product-integration-techniques\">Product Integration Techniques</h2>\n<p>Unlock the full potential of Rikoshea products with our set of specialized integration techniques.</p>\n<p>Leverage our in-depth knowledge to enhance the efficiency and durability of your constructions by correctly incorporating our products.</p>\n<h2 id=\"advanced-use-cases\">Advanced Use Cases</h2>\n<p>Explore the possibilities with Rikoshea through real-world scenarios. Our catalog of advanced use cases demonstrates how our products can solve complex challenges and push the boundaries of conventional construction.</p>\n<p>See how Rikoshea products have been instrumental in:</p>\n"
    }), createVNode($$CardGrid, {
      ...
      "set:html": "These case studies serve as an inspiration and a learning tool, showcasing what can be achieved with the right expertise and Rikoshea’s superior product range."
    })]
  });
}
...
const file = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/advanced/technical-specifications.mdx";
...
Content.moduleId = "/Users/kthrob/Repos/PurpleMartin/rikoshea/src/content/docs/advanced/technical-specifications.mdx";
